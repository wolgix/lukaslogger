...
Config.Zones = {
	MechanicActions = {
		Pos   = { x = -205.30233764648, y = -1337.6784667969, z = 30.000409469604 },
	...
	--Garage = {
	--	Pos   = { x = -199.14593505859, y = -1325.625, z = 31.130367279053 },
	--	Size  = { x = 1.5, y = 1.5, z = 1.0 },
	--	Color = { r = 204, g = 204, b = 0 },
	--	Type  = 1
	--},
	...
	VehicleSpawnPoint = {
		Pos   = { x= -195.40426635742,y= -1304.6253662109,z= 31.325860977173},
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1
	},

	VehicleDeleter = {
		Pos   = { x = -199.81704711914, y = -1324.3265380859, z = 31.007038955688 },
