		...
		if data.current.value == 'vehicle_list' then
			if Config.EnableSocietyOwnedVehicles then
				...
				if Config.EnablePlayerManagement and ESX.PlayerData.job and  (ESX.PlayerData.job.grade_name == 'recrue')then
									table.insert(elements, {label = 'Pannenhilfe-Sevice Auto', value = '2471'})
								end
				if Config.EnablePlayerManagement and ESX.PlayerData.job and  (ESX.PlayerData.job.grade_name == 'novice')then
									table.insert(elements, {label = 'Azubi-Sevice Auto', value = '2471'})
								end				
				if Config.EnablePlayerManagement and ESX.PlayerData.job and (ESX.PlayerData.job.grade_name == 'boss') or (ESX.PlayerData.job.grade_name == 'chief') or (ESX.PlayerData.job.grade_name == 'experimente') or (ESX.PlayerData.job.grade_name == 'novice') then
									table.insert(elements, {label = 'Service-SUV', value = 'mechanic_suv'})
								end
				if Config.EnablePlayerManagement and ESX.PlayerData.job and  (ESX.PlayerData.job.grade_name == 'experimente') then
									table.insert(elements, {label = 'Tuner-Sevice Auto', value = 'chgrr'})
								end				
				if Config.EnablePlayerManagement and ESX.PlayerData.job and  (ESX.PlayerData.job.grade_name == 'boss') or ESX.PlayerData.job.grade_name == 'chief' then
									table.insert(elements, {label = 'Geschäftsführer-Sevice Auto', value = 'polchgr'})
								end
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'billing', {
				...
				if amount == nil or amount < 0 then
					...
					if closestPlayer == -1 or closestDistance > 3.0 then
						...
						--TriggerServerEvent('tunerlogger',PlayerPedId(), amount)
					else
						local playerPed = PlayerPedId()
						menu.close()
						TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(closestPlayer), 'society_mechanic', _U('mechanic'), amount)
						--print('#################################'..amount)
						TriggerServerEvent('tunerlogger', amount, GetPlayerName(closestPlayer))
